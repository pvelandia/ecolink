    ...
    <body>
        <div class="container">
            <h1>¡Solicitud de Recolección CANCELADA!</h1>
            <p class="subtitle">Queremos informarte que tu solicitud ha sido Cancelada. Aquí tienes toda la información:</p>
            ...
            <div class="info-section">
                ...
                <div class="info-box">
                    ...
                    <p><strong>Nombre:</strong> {{ $reciclador->first_name }} {{ $reciclador->last_name }}</p>
                    <p><strong>Teléfono:</strong> {{ $reciclador->phone_number }}</p>
                </div>
            </div>
