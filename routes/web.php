...
Route::middleware(['web'])->group(function () {    
    ...
    Route::get('/register', function () {
        $roles = Role::whereNotIn('name', ['Administrador', 'Bloqueado'])->get();
    ...
    Route::middleware(['auth', CheckRole::class . ':Reciclador'])->prefix('Reciclador')->group(function () {
        ...
        Route::post('/reciclador/asignar-puntos/{id}', [RecoleccionesController::class, 'asignarPuntos'])->name('reciclador.asignarPuntos');
    });
